...
;==============================================================================
	.global delay_1_s
	delay_1_s: 
	// LDI instruction is used to load an immediate value (a constant value) into a register.
	//  RCALL instruction is used to call a subroutine (a small section of code that performs a specific task) at a specified address
	// In assembler, the "ret" instruction is short for "return"
	/* In assembler, the ".global" directive is used to declare a symbol as global. This means that the symbol 
	can be accessed from any other file in the program, regardless of which file it was originally defined in. */
