...
// includes all files/modules necessary for this project
#include <avr/io.h>
#include <inttypes.h>
#include "numkey.h"
#include "../common.h"
 ...
 */
static const char key_map[12] =	{'1', '4', '7', '*',
								 '2', '5', '8', '0',
								 '3', '6', '9', '#'};

// the static keyword is used to declare variables and functions that are local to a particular source file or library.
/*
